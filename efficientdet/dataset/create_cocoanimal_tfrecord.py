...
flags.DEFINE_string('image_dir', '../OID_new', 'Directory containing images.')
flags.DEFINE_string(
...
flags.DEFINE_string(
    'object_annotations_file', '../OID_new/annotations/croco/train_cocoboxes.json', 'File containing object '
    'annotations - boxes and instance masks.')
flags.DEFINE_string('output_file_prefix', 'tmp/train', 'Path to output file')
flags.DEFINE_integer('num_shards', 64, 'Number of shards for output file.')
